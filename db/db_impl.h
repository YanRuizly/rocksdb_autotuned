...
class DBImpl : public DB {
 public:
  ...
  /* add by yr */
  virtual void BloomFilterAuto(double getmicrosec_rate);
  /* add by yr */
 ...
 protected:
  ...
  Statistics* stats_;
  /* add by yanrui */
  uint64_t default_write_buffer_size_ = 64 << 20;
  anon::AtomicCounter switch_memtable_count;
  uint64_t start_time_ = 0;
  uint64_t current_time_ = 0;
  /* 前一次写入的平均速度 */
  double v_prev_ = 0.0 ;
  uint64_t factor_ = 2; /* 增长因子 */
  anon::AtomicCounter search_count;
  uint64_t search_start_time_ = 0;
  uint64_t search_current_time_ = 0;
  uint64_t search_interval_ = 0;
  uint64_t standard_getmicrosec_ = 0;
  anon::AtomicCounter standard_getmicrosec__;
  /* add by yanrui */
