...
MemTable::MemTable(const InternalKeyComparator& cmp,
                   ...
                   SequenceNumber latest_seq, uint32_t column_family_id, Env* env)
    : comparator_(cmp),
