...
struct ImmutableCFOptions {
  ...
  /* add by yr*/
  int default_max_write_buffer_number;
  /* add by yr*/
...
struct MutableCFOptions {
  explicit MutableCFOptions(const ColumnFamilyOptions& options)
      : write_buffer_size(options.write_buffer_size),
        ...
        /* add by yanrui start */
		auto_tuned_memtable(options.auto_tuned_memtable),
  		auto_tuned_bloom(options.auto_tuned_bloom),
  		default_max_write_buffer_number(6),
   		/* add by yanrui end */
  ...
  MutableCFOptions()
      : write_buffer_size(0),
        ...
        /* add by yanrui start */
		auto_tuned_memtable(true),
		auto_tuned_bloom(false),
		default_max_write_buffer_number(6),
		/* add by yanrui end */
  ...
  /* add by yanrui start */
  bool auto_tuned_memtable;
  bool auto_tuned_bloom;
  int default_max_write_buffer_number;
