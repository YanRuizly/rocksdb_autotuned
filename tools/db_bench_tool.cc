...
DEFINE_bool(auto_tuned_memtable, false,
		    "Enable dynamic tuning of memtable when I/O is high");

DEFINE_bool(auto_tuned_bloom_filter, false,
			"Enable dynamic tuning of bloom fillter when select is high");
...
void VerifyDBFromDB(std::string& truth_db_name) {
 ...
 private:
  ...
  void InitializeOptionsFromFlags(Options* opts) {
	...
	/* add by yr */
	//options.default_write_buffer_size = FLAGS_write_buffer_size;
	/* add by yr */
	...
	/* add by yanrui start*/
	options.auto_tuned_memtable = FLAGS_auto_tuned_memtable;
	options.auto_tuned_bloom = FLAGS_auto_tuned_bloom_filter;
 	FLAGS_env->auto_tuned_memtable = FLAGS_auto_tuned_memtable;
	FLAGS_env->auto_tuned_bloom_filter = FLAGS_auto_tuned_bloom_filter;
	/* add by yanrui end*/
